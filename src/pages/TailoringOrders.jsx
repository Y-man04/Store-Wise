...
import { Plus, X, Search, Phone, Trash2, AlertTriangle } from 'lucide-react';
...
const STAGES = SERVICE_STATUS_STAGES.tailoring;

const stageAccent = {
  Cutting: 'border-l-amber-500',
  Stitching: 'border-l-blue-500',
  Fitting: 'border-l-purple-500',
  Ready: 'border-l-emerald-500',
  Delivered: 'border-l-gray-500',
};

const stageBadge = {
  Cutting: 'bg-amber-500/10 text-amber-300 border-amber-500/30',
  Stitching: 'bg-blue-500/10 text-blue-300 border-blue-500/30',
  Fitting: 'bg-purple-500/10 text-purple-300 border-purple-500/30',
...
const emptyForm = () => ({
  ...
  price: '',
  dueDate: '',
  details: SERVICE_FIELD_TEMPLATES.tailoring.map((label) => ({ label, value: '' })),
});
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="card w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl" style={{ backgroundColor: '#111118' }}>
            <div className="flex items-center justify-between p-5 border-b border-white/10">
              <h2 className="text-lg font-bold text-white">New Tailoring Order</h2>
